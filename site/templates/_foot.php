<div class="site-footer-two">
	<img src="<?php echo $config->urls->templates ?>assets/images/shapes/footer-shape-2-1.png" alt="" class="site-footer-two__shape-1">
	<img src="<?php echo $config->urls->templates ?>assets/images/shapes/footer-shape-2-2.png" alt="" class="site-footer-two__shape-2">
